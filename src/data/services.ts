...
export const servicesOverview: ServiceOverviewItem[] = [
  ...
  },
  {
    title: "Ecommerce",
    description:
      "Scalable online stores with seamless checkout, inventory management, and growth-focused design.",
    icon: "shopping-cart",
    href: "/services/web-development",
  },
  {
    ...
    description:
      "Data-driven dashboards and analytics to track KPIs, forecast trends, and make informed decisions.",
    icon: "bar-chart",
    href: "/services/ai-automation",
  },
];
