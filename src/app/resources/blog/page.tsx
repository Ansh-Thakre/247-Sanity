...
import { allPosts, type BlogPostPreview } from "@/data/blog-posts";
  ...
  return (
    ...
    >
      <Link
        ...
        className="group flex flex-col h-full bg-white rounded-2xl border border-border overflow-hidden hover:shadow-[0_8px_40px_rgba(30,90,152,0.12)] hover:border-primary/30 transition-all duration-300"
      >
        <div
          className={`h-40 sm:h-44 bg-linear-to-br ${post.gradient} flex items-end p-4`}
        >
